    ...
    public partial class init1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FormSubmissionFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FormSubmissionFields_FormFields_FormFieldId",
                        column: x => x.FormFieldId,
                        principalTable: "FormFields",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FormSubmissionFields_FormSubmissions_FormSubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FormSubmissionFields_FormFieldId",
                table: "FormSubmissionFields",
                column: "FormFieldId");

            migrationBuilder.CreateIndex(
                name: "IX_FormSubmissionFields_FormSubmissionId",
                table: "FormSubmissionFields",
